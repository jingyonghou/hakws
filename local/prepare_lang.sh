...
echo "utils/make_lexicon_fst.pl --pron-probs $tmpdir/lexiconp.txt $sil_prob $silphone > $dir/lexicon.fst.txt.nodis"
...
echo " utils/make_lexicon_fst.pl --pron-probs $tmpdir/lexiconp_disambig.txt $sil_prob $silphone '#'$ndisambig > $dir/lexicon.fst.txt"
if $silprob; then
